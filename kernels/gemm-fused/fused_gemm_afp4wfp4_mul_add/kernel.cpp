// fused_gemm_afp4wfp4_mul_add: FP4 GEMM with multiply-add epilogue
//
// C = c_a * fp4_gemm(A, B, a_scale, b_scale) + c_b
//
// FP4 data is pre-dequantized to BF16 by the host. Scales applied per K-block.
// The multiply-add epilogue is fused inline after accumulation.
//
// Ported from: reference/triton/fused/fused_gemm_afp4wfp4_mul_add.py
...
struct fused_gemm_afp4wfp4_mul_add_globals {
...
void fused_gemm_afp4wfp4_mul_add_kernel(const fused_gemm_afp4wfp4_mul_add_globals g,
                                           int M, int N, int K) {
...
void dispatch_fused_gemm_afp4wfp4_mul_add(fused_gemm_afp4wfp4_mul_add_globals g) {
    unsigned long mem_size = g.dynamic_shared_memory();
    hipFuncSetAttribute((void*)fused_gemm_afp4wfp4_mul_add_kernel,
        hipFuncAttributeMaxDynamicSharedMemorySize, mem_size);
    fused_gemm_afp4wfp4_mul_add_kernel<<<g.grid(), g.block(), mem_size, g.stream>>>(
        g, g.M, g.N, g.K);
}

PYBIND11_MODULE(fused_gemm_afp4wfp4_mul_add_tk, m) {
    m.doc() = "HipKittens FP4 GEMM with fused multiply-add epilogue";
    kittens::py::bind_function<dispatch_fused_gemm_afp4wfp4_mul_add>(m, "dispatch",
        &fused_gemm_afp4wfp4_mul_add_globals::a,
        &fused_gemm_afp4wfp4_mul_add_globals::b,
        &fused_gemm_afp4wfp4_mul_add_globals::c,
        &fused_gemm_afp4wfp4_mul_add_globals::a_scale,
        &fused_gemm_afp4wfp4_mul_add_globals::b_scale,
        &fused_gemm_afp4wfp4_mul_add_globals::c_a,
        &fused_gemm_afp4wfp4_mul_add_globals::c_b);
}
